...
func NewRunCommand(dockerCli command.Cli) *cobra.Command {
	...
	flags.StringVar(&opts.CreateOption.Name, "name", "", "Assign a name to the container")
	...
	command.AddPlatformFlag(flags, &opts.CreateOption.Platform)
	command.AddTrustVerificationFlags(flags, &opts.CreateOption.Untrusted, dockerCli.ContentTrustEnabled())
...
func runContainer(dockerCli command.Cli, opts *RunOptions, copts *ContainerOptions, containerConfig *containerConfig) error {
	...
	createResponse, err := createContainer(ctx, dockerCli, containerConfig, &opts.CreateOption)
	if err != nil {
